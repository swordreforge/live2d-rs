    ...
    pub fn to_style(&self) -> Style {
        ...
        Style {
            visuals: egui::Visuals {
                ...
                window_fill: if self.dark_mode { n.c900 } else { n.c100 },
                window_stroke: Stroke::new(1.0_f32, if self.dark_mode { n.c700 } else { n.c300 }),
                ...
                panel_fill: if self.dark_mode { n.c900 } else { n.c100 },
                faint_bg_color: if self.dark_mode { n.c800 } else { n.c100 },
                extreme_bg_color: if self.dark_mode { n.c950 } else { n.c50 },
                code_bg_color: if self.dark_mode { n.c800 } else { n.c200 },
                ...
                widgets: egui::style::Widgets {
                    noninteractive: egui::style::WidgetVisuals {
                        bg_fill: if self.dark_mode { n.c900 } else { n.c100 },
                        weak_bg_fill: if self.dark_mode { n.c800 } else { n.c100 },
                        bg_stroke: Stroke::new(1.0_f32, if self.dark_mode { n.c700 } else { n.c300 }),
                        rounding: Rounding::same(8.0),
                        fg_stroke: Stroke::new(1.0_f32, text_color),
                        expansion: 0.0,
                    },
                    inactive: egui::style::WidgetVisuals {
                        bg_fill: if self.dark_mode { n.c800 } else { n.c100 },
                        weak_bg_fill: if self.dark_mode { n.c700 } else { n.c200 },
                        bg_stroke: Stroke::new(1.0_f32, if self.dark_mode { n.c700 } else { n.c300 }),
                        rounding: Rounding::same(8.0),
                        fg_stroke: Stroke::new(1.0_f32, text_color),
                        expansion: 0.0,
                    ...
                    hovered: egui::style::WidgetVisuals {
                        ...
                        bg_stroke: Stroke::new(1.0_f32, p.c500.linear_multiply(0.3)),
                        rounding: Rounding::same(8.0),
                        fg_stroke: Stroke::new(1.5_f32, p.c500),
                        expansion: 1.0,
                    },
                    active: egui::style::WidgetVisuals {
                        bg_fill: p.c500.linear_multiply(0.25),
                        weak_bg_fill: p.c500.linear_multiply(0.15),
                        bg_stroke: Stroke::new(1.0_f32, p.c600),
                        rounding: Rounding::same(8.0),
                        fg_stroke: Stroke::new(2.0_f32, p.c600),
                        expansion: 1.0,
                    },
